...
namespace Dot.Net.WebApi.Controllers
{
    ...
    public class RuleNameController : Controller
    {
        ...
        public IActionResult AddRuleName([FromBody]RuleDTO trade)
        {
            return View("ruleName/add");
        }

        [HttpGet("/ruleName/add")]
        public IActionResult Validate([FromBody]RuleDTO trade)
        {
        ...
        public IActionResult updateRuleName(int id, [FromBody] RuleDTO rating)
        {
